...
import { getCompany, getDefinedTermsByProvision, getDocuments, getPosition } from "@/lib/coherent";
    ...
    <div className="stack">
          ...
          <Card key={doc.id}>
            ...
            {capacity.securedBindingProvision ? (
              ...
              <div style={{ fontSize: 13, padding: "10px 0" }}>
                <b>Secured capacity:</b>{" "}
                <span className="mono">{fmtCapacity(capacity.securedStatus, capacity.securedCapacity)}</span>{" "}
            ...
            {capacity.unsecuredBindingProvision ? (
              ...
              <div style={{ fontSize: 13, padding: "10px 0" }}>
                <b>Unsecured capacity:</b>{" "}
                <span className="mono">{fmtCapacity(capacity.unsecuredStatus, capacity.unsecuredCapacity)}</span>{" "}
                <span className="muted">
      ...
      <Card style={{ background: "#fcfbf8" }}>
        <div style={{ fontSize: 13, lineHeight: 1.55 }} className="muted">
          ...
          ratio) basket sizes are shown at their full, larger size on the Position tab for reference; only the
