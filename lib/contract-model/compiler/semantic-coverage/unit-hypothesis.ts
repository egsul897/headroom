...
export function classifyMateriality(signals: SignalHit[]): { materiality: SemanticUnitMateriality; reasoning: string } {
...
function buildUnit(input: {
  ...
  const { materiality, reasoning } = classifyMateriality(input.signals);
