/**
 * FINAL PHASE 3 CLOSURE - Unit C: frozen A1-A6/B1-B4 semantic holdout
 * execution. Real compile+verify calls against the PRECOMMITTED source
 * regions named in docs/final-lightweight-unseen/07-targeted-ground-truth.json,
 * located directly via real character offsets in the raw source text (not
 * discovery's own first-N sampling, per the mission's own Section 16).
 * Zero semantic production code touched (see 10-semantic-freeze-proof.json).
 */
...
const OUT_DIR = "tests/fixtures/unseen-packages/final-phase3-closure-holdout-run";
