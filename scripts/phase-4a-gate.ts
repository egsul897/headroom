...
const gate: [number, string, boolean, string][] = [
  ...
  [3, "Phase-3 semantic production tree remains frozen", semanticFrozen, `semantic tree ${semanticTreeAtHead}; compiler tree ${compilerTreeAtHead}; dirty compiler/ir files: ${semanticDirty.length}`],
